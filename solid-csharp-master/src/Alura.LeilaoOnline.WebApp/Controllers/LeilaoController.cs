...
{
    //S.O.L.I.D
    //S Single response dependencia Princípio da responsabilidade única. 
    //D dependency inversion principle (DIP) princípio da inversão da dependência = qualidade da dependência.
